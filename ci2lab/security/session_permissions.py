...
def _normalize_slashes(text: str) -> str:
    ...
    Converts backslashes to forward slashes, trims whitespace, drops a leading
    ``./``, and collapses the result through :class:`PurePosixPath` so equivalent
    spellings of the same target fingerprint identically.
    """
